...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 105.666687, 89.333328, 77.0, 22.0 ],
					"style" : "",
					"text" : "pasSonifier1"
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-25::obj-3" : [ "umenu", "umenu", 0 ],
			"obj-25::obj-98" : [ "live.gain~[3]", "live.gain~", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "pasSonifier1.maxpat",
				"bootpath" : "~/Dropbox/GroupFlow",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "pasBedPoly1.maxpat",

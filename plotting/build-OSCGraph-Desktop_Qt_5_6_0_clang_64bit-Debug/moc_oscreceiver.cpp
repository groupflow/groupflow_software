/****************************************************************************
** Meta object code from reading C++ file 'oscreceiver.h'
**
...
#include "../OSCGraph/oscreceiver.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'oscreceiver.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 12, 9), // "slot_Stop"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "OSCReceiver\0slot_Stop\0"
};
...
const QMetaObject OSCReceiver::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_OSCReceiver.data,
      qt_meta_data_OSCReceiver,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *OSCReceiver::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "osc::OscPacketListener"))
        return static_cast< osc::OscPacketListener*>(const_cast< OSCReceiver*>(this));
